...
interface EnterpriseAuditRow extends RowDataPacket {
  id: string
...
export interface AtcEnterpriseAuditEntry {
  id: string
...
export class EnterpriseAuditRepository {
  ...
  async append(
    ...
    try {
      ...
      await conn.execute<ResultSetHeader>(
        `INSERT INTO atc_enterprise_audit
