...
> Both engines are verified: the full file imports with 367 tables and no errors
> on MariaDB 10.11 and on MySQL 8.0.46, and all 361 migrations apply in order on
> both. MariaDB 11 has not been tested here.
